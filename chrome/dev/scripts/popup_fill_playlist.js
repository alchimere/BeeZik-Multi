...
var tab_line = '<tr class="@CLASS@" id="tr_@J@"\
					...
					onmouseout= "$(\'img_play_@ID@\').style.display = \'none\'; $(\'img_suppr_@ID@\').style.visibility = \'hidden\';">\
					 	<td width="16" id="td_0_@J@" style="background-image: url(\'images/@PUCE@\'); background-repeat: no-repeat;">\
					 			<img src="images/del.png" id="img_suppr_@ID@" style="visibility:hidden; cursor:pointer"\
									 title="Supprimer"\
									 onclick="delete_song(@I@, \'notReload\'); fill_list();"/>\
						</td>\
						<td width="133">\
							<div class="name" title="@ARTIST2@">\
								<img src="images/play.gif" id="img_play_@ID@" style="float:left; margin-right:5px; display:none; cursor:pointer"\
										 title="Jouer extrait 30s"\
										 onclick="changeZik(@ID@, @I@);"/>\
								<div class="name" onclick="open_songtab(\'http://www.beezik.com/telecharger/t/@ID@\', @I@)">\
									@ARTIST1@\
								</div>\
							</div>\
						</td>\
						<td width="233" onclick="open_songtab(\'http://www.beezik.com/telecharger/t/@ID@\', @I@)">\
